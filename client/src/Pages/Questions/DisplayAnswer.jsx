...
const DisplayAnswer = ({question, handleShare}) => {
    ...
    const[Aid, setAid] = useState(0) // for comment
    ...
    const handleComment = (e,Iddd) => {
        ...
        // document.getElementById('pcom').value=""
        setShow(!Show)
                ...
                question.answer.map((ans) => (
                    <div className="display-ans" key={ans._id}>
                        ...
                        <div  className='commentbox' >  
                            <button onClick={() => {setShow(!Show);setAid(ans._id);}} >Add a Comment</button>
            
                                <form onSubmit={ (e) => { handleComment(e, ans._id)}}>
                                {
                                    
                                    Show && ans._id === Aid && (<div className='title'>
                                        <textarea name="" id="pcom" onChange={(e) => {setComment(e.target.value)}} cols="30" rows="10" placeholder='Add your comment...' onKeyPress= {(e) => {handleEnter(e,ans._id)}}></textarea><br/>
